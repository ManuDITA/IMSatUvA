...
resource "aws_ImsApi_rest_api" "ImsApi" {
...
resource "aws_ImsApi_resource" "inventoryManagement" {
    rest_api_id = aws_ImsApi_rest_api.ImsApi.id
    parent_id = aws_ImsApi_rest_api.ImsApi.root_resource_id
...
resource "aws_ImsApi_method" "inventoryManagement_method" {
    rest_api_id = aws_ImsApi_rest_api.ImsApi.id
    resource_id = aws_ImsApi_resource.inventoryManagement.id
    http_method = "ANY"
    authorization = "NONE"
}
...
resource "aws_ImsApi_integration" "hello_lambda_integration" {
  ...
  rest_api_id             = aws_ImsApi_rest_api.ImsApi.id
  resource_id             = aws_ImsApi_method.inventoryManagement.id
  http_method             = aws_ImsApi_method.inventoryManagement_method.http_method
